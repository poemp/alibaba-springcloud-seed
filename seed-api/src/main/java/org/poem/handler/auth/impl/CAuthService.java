package org.poem.handler.auth.impl;
 ...
 */
@Service
@FeignClient(name = ProviderName.SEED_AUTH, configuration = {ErrMsgConfiguration.class})
public interface CAuthService {
    ...
    @ApiResponses({@ApiResponse(code = 400, message = "请求参数没有填好"), @ApiResponse(code = 404, message = "请求路径没有找到")})
    @PostMapping(value = "/v1/auth/post")
